    ...
    { 
        ...
        private void FixedUpdate()
        {
            ...
            if (NearGround)
            {
                ...
                VehicleRigidbody.AddForce(transform.right * strafeTarget, ForceMode.Acceleration);
            }
            else
            {
                VehicleRigidbody.AddForce(transform.forward * (speedTarget / 10), ForceMode.Acceleration);
            ...
            if (NearGround)
            {
                VehicleRigidbody.velocity = transform.TransformVector(localVelocity);
            }
            
            transform.position = VehicleRigidbody.transform.position + modelHeightOffGround;
        ...
        {
            currentSpeed = Vector3.Dot(transform.forward, VehicleRigidbody.velocity);
        ...
        private void CounterSlopes(Vector3 groundNormal)
        {
            ...
            VehicleRigidbody.AddForce(-directionOfSlope * affectOfWheelAlignment * affectOfGravity, ForceMode.Acceleration);
        }
        ...
        {
            VehicleRigidbody.AddForce(Vector3.up * force, forceMode);
        }
